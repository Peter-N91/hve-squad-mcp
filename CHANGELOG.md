...
release later superseded, and the twelve releases since rebuilt the squad roster against
the agents HVE Core actually deploys. Nothing here is a mechanical version bump.
...
- **Bumped the package pin to `Peter-N91/hve-squad@0.12.4` and rebuilt the bundle** from commit `b3b385cd5a1e5f1a9e0908fe1318c491d82d9e88` against `microsoft/hve-core@d6b82a0ff65677ec1089a90922004a555ec13111`. It carries the squad-owned charters `Squad Researcher`, `Squad Lead`, `Squad Implementor`, `Squad Reviewer`, `Squad Challenger`, `Squad Backlog Executor`, `Squad Technical Writer`, `Squad Prompt Engineer`, `Squad Risk Manager`, `Squad Observability Planner`, `Squad Performance Planner`, and `Squad Vulnerability Manager`, and no longer carries the retired `Task *` personas.
