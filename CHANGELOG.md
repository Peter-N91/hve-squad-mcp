...
[0.6.3]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.6.3
...
[0.6.1]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.6.1
...
[0.5.0]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.5.0
...
[0.4.1]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.4.1
...
> Built against `Peter-N91/hve-squad@0.12.8` (see `host/cast/package-pin.json`).
...
```powershell
npm install "Peter-N91/hve-squad-mcp#v0.3.9"
```

[0.3.9]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.3.9
...
```powershell
npm install "Peter-N91/hve-squad-mcp#v0.3.8"
```

[0.3.8]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.3.8
...
```powershell
npm install "Peter-N91/hve-squad-mcp#v0.3.5"
```

[0.3.5]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.3.5
...
- **Bumped the bundled cast pin from `0.12.4` to `Peter-N91/hve-squad@0.12.6`** and refreshed `host/cast/` from that release's `apm.yml`. A cast change is a patch: the squad a consumer gets is different.
...
```powershell
npm install "Peter-N91/hve-squad-mcp#v0.3.2"
```

[0.3.2]: https://github.com/Peter-N91/hve-squad-mcp/releases/tag/v0.3.2
...
```powershell
npm install "Peter-N91/hve-squad-mcp#v0.3.0"
```
